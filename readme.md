...
What makes pseudocode so powerful is that any computer program, even a highly complex one, can be described using a combination of only simple mathematical notation and basic operations. Programs written in pseudocode are readable because they avoid unnecessary punctuation and unclear symbols, and use conventional words to describe programs (such as **if**, **while**, **do** and **end**).
