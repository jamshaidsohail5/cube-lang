...
Most computer programs describe algorithms, which are sets of instructions that when executed provide the solution to a specific problem. Simple, clear programs that are easy to modify and test are highly valued by the programming community, compared to more complex solutions for the same problem.
