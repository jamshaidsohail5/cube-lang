...
This simplifies the creation of domain specific languages, and enables [polyglot programming](https://www.graalvm.org/docs/reference-manual/polyglot), which combine the best features of different languages (such as functional programming combined with SQL over collections) into single programs.
