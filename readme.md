...
Cube is a polyglot language, and combines the best features of several programming languages into single programs. Because embedded languages such as SQL have flexible layout, Cube does not require lines breaks or tabs to delimit blocks.
