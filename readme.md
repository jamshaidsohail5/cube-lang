...
In Cube, the `output` keyword can be used to return an output a value. The example higher-order function below accepts a block of code as input, then executes the lambda to output a timing benchmark.
