...
Cube uses a verb-based [dependency grammar](https://en.wikipedia.org/wiki/Dependency_grammar) inspired by psudeocode, and has a syntax similar to other psueocode-inspired languages such as [SQL](https://en.wikipedia.org/wiki/SQL), [Lua](https://en.wikipedia.org/wiki/Lua_(programming_language)) and [Julia](https://en.wikibooks.org/wiki/Introducing_Julia/Controlling_the_flow).
