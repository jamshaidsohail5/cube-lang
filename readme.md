...
Cube is a polyg;ot language, and combines the best features of several programming languages into single programs. Because embedded languages such as SQL have flexible layout, Cube and does not require new lines or tabs to delimit blocks.
