...
A second source of inspiration is [dependency grammar](https://en.wikipedia.org/wiki/Dependency_grammar), a framework used in Computational Linguistics research for a wide variety of natural language processing tasks, such as translating one language into another. Cube uses a form of dependency grammar that is designed to be easily extensible. This simplifies the creation of domain specific languages, as well as [polyglot programs](https://www.graalvm.org/docs/reference-manual/polyglot), which combines the best features of different programming languages (such as functional programming and SQL) to solve problems more easily than using a single language.
