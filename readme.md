...
A second source of inspiration is [dependency grammar](https://en.wikipedia.org/wiki/Dependency_grammar), a flexible framework used in Computational Linguistics research for processing a wide variety of different natural languages. Cube uses a form of dependency grammar that is easily extensible. This simplifies the creation of domain specific languages, and enables features of different programming language families (such as functional programming and SQL) to be used together in the same readable program.
